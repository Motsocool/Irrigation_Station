...
while True:
    try:
        ...
        relays_one_timer.init(period=6000, mode=Timer.ONE_SHOT, callback=cb_relays_oneoff)
        relays_two_timer.init(period=6000, mode=Timer.ONE_SHOT, callback=cb_relays_twooff)
        relays_three_timer.init(period=6000, mode=Timer.ONE_SHOT, callback=cb_relays_threeoff)
        relays_four_timer.init(period=6000, mode=Timer.ONE_SHOT, callback=cb_relays_fouroff)
        relays_five_timer.init(period=6000, mode=Timer.ONE_SHOT, callback=cb_relays_fiveoff)
        relays_six_timer.init(period=6000, mode=Timer.ONE_SHOT, callback=cb_relays_sixoff)
        relays_seven_timer.init(period=6000, mode=Timer.ONE_SHOT, callback=cb_relays_sevenoff)
        relays_eight_timer.init(period=6000, mode=Timer.ONE_SHOT, callback=cb_relays_eightoff)
